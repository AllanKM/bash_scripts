...
$title="Aus Open 2006 VE Search FileInformation results";
...
#$include = "WEBSERVER.EVENTS.ORIGIN";
$include = "at1006[bc] at1007[bc] at1008[bc] dt1206[bc] dt1207[bc] dt1208[bc] gt0806[bc] gt0807[bc] gt0808[bc]";
