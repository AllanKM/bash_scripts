...
# t e s t   v e r s i o n   n o   l d a p   22

#*******************************************************************************************************
# securityConfig_v2.py -- based on migration from enableSecurity.jacl
#   Author: James Walton
...
def usage():
	...
	print '   wsadmin -lang jython -f tip_securityConfig_v2.py -ED -ldappassword <ldapPassword> -bindpassword <bindPassword> '	
...
def configTCR():
   print 'Configuring TCR TIP security'  
...
# If TIPProfile, call that method   Shall this version of the security script only support TIPProfile 
